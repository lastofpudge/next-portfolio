    ...
    (_.Scene = function (e) {
              ...
              (e
                ? l.enabled() && o
                  ? ((t = l.info('scrollPos')),
                    ...
                    d.trigger('update', { startPos: a.start, endPos: a.end, scrollPos: t }),
                    d.progress(n))
                  : m && p === f && T(!0)
                : l.updateScene(d, !1)),
            d
        ...
        y = function (e) {
          ...
          if (l && (n || 0 < v)) {
            if (n)
              if (n.parentNode) {
                for (
                  var r = l.info(), o = R.get.offset(r.container), i = r.vertical ? 'top' : 'left';
      ...
      function L(e) {
        l &&
          ...
          l._setScrollPos(
            l.info('scrollPos') -
              ((e.wheelDelta || e[l.info('vertical') ? 'wheelDeltaY' : 'wheelDeltaX']) / 3 ||
                30 * -e.detail)
          ))
      }
      var T = function (e) {
          ...
          m &&
            ...
            e || p !== f
              ? ((r = { position: w.inFlow ? 'relative' : 'absolute', top: 0, left: 0 }),
                (o = R.css(n, 'position') != r.position),
                w.pushFollowers
                  ? 0 < h.duration &&
                    ((p === u && 0 === parseFloat(R.css(w.spacer, 'padding-top'))) ||
                      (p === c && 0 === parseFloat(R.css(w.spacer, 'padding-bottom')))) &&
                    (o = !0)
                  : (r[t.vertical ? 'top' : 'left'] = h.duration * g),
                R.css(n, r),
                o && A())
              : ('fixed' != R.css(n, 'position') && (R.css(n, { position: 'fixed' }), A()),
