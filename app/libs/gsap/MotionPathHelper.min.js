...
!(function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      var x = (a === o ? -1 : 1) * $(w),
        ...
        H = (-m - C) / i,
        R = D * D + M * M,
        N = (M < 0 ? -1 : 1) * Math.acos(D / $(R)),
        L = (D * H - M * T < 0 ? -1 : 1) * Math.acos((D * T + M * H) / $(R * (T * T + H * H)))
      ...
      for (z = 0; z < X; z++)
        (_ = F((s = N + z * O))),
          ...
          (D = F((s += O))),
          (M = W(s)),
          I.push(_ - G * m, m + G * _, D + G * M, M - G * D, D, M)
      for (z = 0; z < I.length; z += 2)
        (_ = I[z]), (m = I[z + 1]), (I[z] = _ * V + m * Y + E), (I[z + 1] = _ * q + m * B + k)
      return (I[z - 2] = r), (I[z - 1] = h), I
    }
  }
  function stringToRawPath(t) {
    ...
    for (e = 0; e < y; e++)
      if (
        ...
        (c = v),
          (d = b),
          ('C' !== p && 'S' !== p) || ((c += v - r[r.length - 4]), (d += b - r[r.length - 3])),
          o || (v = b = 0),
        ...
        (c = v - r[r.length - 4]),
          ...
          (e += 2)
      else if ('H' === a) od(v, b, (v = i), b), (e += 1)
      else if ('V' === a) od(v, b, v, (b = i + (o ? b - v : 0))), (e += 1)
      else if ('L' === a || 'Z' === a)
        ...
        if (
          ...
          (n = 7),
          1 < g.length &&
            (g.length < 3 ? ((d = c), (c = f), n--) : ((d = f), (c = g.substr(2)), (n -= 2)),
            (f = g.charAt(1)),
            (g = g.charAt(0))),
          (u = arcToSegment(
            v,
  ...
  function pointsToSegment(t, e, n) {
    ...
    for (
      ...
      (i = b),
        ...
        (m = (c = P - i) * c + (u = A - s) * u),
        (g = ((a = Math.acos((f + _ - m) / $(4 * f * _))) / Math.PI) * e),
        (p = $(f) * g),
        (g *= $(_)),
        (b === i && y === s) ||
          (n < a
    ...
    for (P = A; y <= s; )
      (g =
        (f = (m = 1 - y) * m * m * o + 3 * m * m * y * h + 3 * m * y * y * c + y * y * y * u - e) *
          f +
        (_ = m * m * m * r + 3 * m * m * y * l + 3 * m * y * y * d + y * y * y * p - n) * _) < P &&
        ((P = g), (b = y)),
        (y += v)
    return 1 < t
  ...
  function getGlobalMatrix(t, e, n) {
    ...
    if ((l.removeChild(a), i))
      for (o = i.length; o--; ) ((r = i[o]).scaleX = r.scaleY = 0), r.renderTransform(1, r)
  ...
  function La(t, e) {
    ...
    if (
      ...
      if (
        ...
        h ||
          (za(D, 'mouseup', n._onRelease), t && t.target && za(t.target, 'mouseup', n._onRelease)),
        o
          ? (n.isDragging = !1)
    ...
    rt =
      (((n = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
        ...
        ;(this.pointerX = t),
          ...
          this.snap &&
            !N &&
            ((it.x = s), (it.y = a), this.snap.call(this, it), (s = it.x), (a = it.y)),
          (this.x === s && this.y === a) ||
            ((this._matrix.f = this.y = a),
            (this._matrix.e = this.x = s),
            !this.isDragging &&
              this.isPressed &&
              ((this.isDragging = !0), Ea('onDragStart', this, this.pointerEvent)))
      }),
  ...
  var ct,
    dt =
      ...
      (ct.init = function init() {
        ...
        if (((this._rawPath = i), a)) {
          if (((this._anchors = Ma(i, 0, this, o)), 1 < (t = i.length)))
            for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Ma(i, e, this, o))
          ...
          ? ((t.smooth = !t.smooth),
            ...
            t.smooth && !c
              ? ((e =
                ...
                i < 0.2 &&
                  ((i = Na(h, r, r - 6) / 4),
                  (e = n || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                s < 0.2 &&
                  ((s = Na(h, r, r + 6) / 4),
                  (n = e || Math.atan2(h[r + 7] - h[r - 5], h[r + 6] - h[r - 6]))),
                (a = Math.sin(e)),
                (o = Math.cos(e)),
      ...
      (ct._onPressAlt = function _onPressAlt() {
        var t = this._editingAnchor
        t &&
          (t.i && (this._handle1.style.visibility = this._line1.style.visibility = 'visible'),
        ...
        for (s = 0; s < h; s++)
          (i = (o = r[s]).i),
            ...
            i < a.length - 2 &&
              ...
              (a[i + 3] = (((a[i + 3] + n) * l) | 0) / l)),
            o !== t &&
              o.element.setAttribute('transform', 'translate(' + a[i] + at + a[i + 1] + ')')
        this.update()
      }),
        ...
        if (
          ...
          o &&
            ...
            e &&
              ((i = n[e - 2]),
              (s = n[e - 1]),
              this._handle1.setAttribute('transform', 'translate(' + i + at + s + ')'),
              this._line1.setAttribute('points', i + at + s + at + n[e] + at + n[e + 1])),
            e < n.length - 2 &&
              ((i = n[e + 2]),
              (s = n[e + 3]),
              this._handle2.setAttribute('transform', 'translate(' + i + at + s + ')'),
              this._line2.setAttribute('points', n[e] + at + n[e + 1] + at + i + at + s))),
          t)
        )
      ...
      (ct.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          g = 1 / (c[p - 2] + d),
          f = -t || c[p - 1] + u
        for (f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = st.length = 0; a < p; a += 2)
          (st[a] = (((c[a] + d) * g) | 0) / 1e3), (st[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3)
        if (i) {
        ...
        return n && 8 === p && 0 === st[0] && 0 === st[1] && 1 === st[p - 2] && 1 === st[p - 1]
          ? st.slice(2, 6).join(',')
  ...
  function PathEditor(t, e) {
    ;(e = e || {}),
          ...
          ;(D = document),
            ...
            (O = (function (t) {
              for (
                var e = t.split(','),
                  n = (
                    void 0 !== I.onpointerdown
                      ? 'pointerdown,pointermove,pointerup,pointercancel'
                      : void 0 !== I.onmspointerdown
      ...
      (this._selection =
        e._selection || ma('g', this._g, { class: 'path-editor-selection path-editor' })),
    ...
    !1 !== e.draggable &&
      ...
      this._saveState(),
      h ||
        (ya(this._selectionHittest, 'mousedown', Da(this._onClickSelectionPath, this)),
  ...
  ;(dt.simplifyPoints = simplifyPoints),
    ...
    (dt.simplifySVG = function (t, e) {
      ...
      if (
        ((d = (e = e || {}).tolerance || 1),
        (c = e.precision || 1 / d),
        (p = (void 0 === e.cornerThreshold ? 18 : +e.cornerThreshold) * K),
  ...
  function _a(t, e) {
    var n = gt.createElementNS
      ? gt.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : gt.createElement(t)
    return n.style ? n : gt.createElement(t)
  }
  function fb(t, e, n) {
    return $a(t) && Pt.test(t)
      ? gt.querySelector(t)
      : Array.isArray(t)
        ? bt(vt([{ x: ut.getProperty(e, 'x'), y: ut.getProperty(e, 'y') }].concat(t), n))
        : $a(t) || (t && 'path' === (t.tagName + '').toLowerCase())
          ? t
          : 0
  }
  function kb(t, e) {
    ...
    ;(pt = window),
      ...
      (mt = ut && ut.plugins.motionPath)
        ? ((function _initCopyToClipboard() {
            ;((yt = _a('textarea')).style.display = 'none'), _t.appendChild(yt)
          })(),
  ...
  var ut,
    ...
    yt,
    Pt = /(^[#\.][a-z]|[a-y][a-z])/i,
    At = { matrix: { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 } },
    wt =
  ...
  function MotionPathHelper(t, e) {
    ...
    t instanceof ut.core.Tween
      ...
      l && !i && (i = fb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
        ...
        s
          ? ((h = n.ownerSVGElement),
            ...
            (a = (u = (function _getConsolidatedMatrix(t) {
              return (t.transform.baseVal.consolidate() || At).matrix
            })(n)).e),
            (o = u.f),
            (m.x = d.x),
            (m.y = d.y))
