...
!(function (e, t) {
  ...
  function ScrollSmoother(e) {
    ...
    function Fa(e) {
      ;(m.scrollTop = 0),
        (e.target.contains && e.target.contains(m)) ||
          (T && !1 === T(o, e)) ||
          (K.isInViewport(e.target) || e.target === d || o.scrollTo(e.target, !1, 'center center'),
          (d = e.target))
    }
    function Ga(e) {
      var r, n, o, i
                ...
                if (e.offset) {
                  if (i) {
                    ...
                    o =
                      h +
                      s +
                      v * ((I.utils.clamp(e.start, e.end, r) - e.start - s) / (n - e.start) - c)
                  }
                  ;(o = (function _round(e) {
    ...
    z.forEach(function (e) {
      ...
      x && (this.normalizer = K.normalizeScroll(!0 === x ? { debounce: !0, content: !k && n } : x)),
      K.config(e),
      'overscrollBehavior' in L.getComputedStyle(U) &&
        I.set([U, O], { overscrollBehavior: 'none' }),
      'scrollBehavior' in L.getComputedStyle(U) && I.set([U, O], { scrollBehavior: 'auto' }),
