...
!(function (t, e) {
          ...
          : 'circle' === L || 'ellipse' === L
            ...
            : 'line' === L
              ...
              : ('polyline' !== L && 'polygon' !== L) ||
                ((n =
                  'M' +
                  (r = (u = (t.getAttribute('points') + '').match(R) || []).shift()) +
                  ',' +
                  (a = u.shift()) +
                  ' L' +
                  u.join(',')),
  ...
  function measureSegment(t, e, n) {
    ...
    if (R.length && N)
      for (
        t.totalLength = y = R[R.length - 1] || 0, t.minLength = N, x = v = 0, r = 0;
        r < y;
        r += N
      )
        S[x++] = R[v] < r ? ++v : v
  ...
  function getProgressData(t, e, n, r) {
    ...
    return (
      ...
      r &&
        1 === u &&
        (h + 6 < g.length ? ((h += 6), (u = 0)) : f + 1 < t.length && ((h = u = 0), (g = t[++f]))),
      (n.t = u),
      (n.i = h),
      (n.path = t),
      (n.segment = g),
  ...
  function getPositionOnPath(t, e, n, r) {
    ...
    return (
      ...
      (f = c[(h = 6 * ~~(h / o))]),
      (p.x = C(
        (u * u * (c[h + 6] - f) + 3 * g * (u * (c[h + 4] - f) + g * (c[h + 2] - f))) * u + f
      )),
      (p.y = C(
        (u * u * (c[h + 7] - (f = c[h + 1])) + 3 * g * (u * (c[h + 5] - f) + g * (c[h + 3] - f))) *
          u +
          f
      )),
      n &&
  ...
  function arcToSegment(t, e, n, r, a, o, i, s, l) {
    if (t !== s || e !== l) {
      ...
      for (G = 0; G < z.length; G += 2)
        (m = z[G]), (v = z[G + 1]), (z[G] = m * j + v * V + S), (z[G + 1] = m * k + v * X + N)
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < P; e++)
      if (
        ...
        (u = x),
          (f = y),
          ('C' !== c && 'S' !== c) || ((u += x - s[s.length - 4]), (f += y - s[s.length - 3])),
          i || (x = y = 0),
      ...
      return t && t.length
        ? (i &&
            ('self' === i || (r = V(i)[0] || e) === e
              ...
              : (u && !1 !== u[2]
                  ? z.set(e, { transformOrigin: 100 * u[0] + '% ' + 100 * u[1] + '%' })
    ...
    a = {
      ...
      init: function init(t, e) {
        ...
        if (
          ...
          for (r in (a && o
            ? i.push(ka(this, ha(ha([], s, a, 0), s, o, 1), t, e.x || a, e.y || o, u, e))
            : (a = o = 0),
          l))
