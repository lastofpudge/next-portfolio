...
!(function (e, t) {
  ...
  function v(e, t) {
    if (e.parentNode && (u || b(e))) {
      var o = S(e),
        ...
        l = u.createElementNS
          ? u.createElementNS(n.replace(/^https/, 'http'), i)
          : u.createElement(i)
      return (
        t &&
          (o
      ...
      if ((c.length || c.push(v(e, 1), v(e, 2), v(e, 3)), (o = s ? g : p), s))
        ...
        if (((r = a = 0), f))
          for (n = e.offsetParent, i = e; (i = i && i.parentNode) && i !== n && i.parentNode; )
            4 < (d.getComputedStyle(i)[m] + '').length &&
  ...
  function getGlobalMatrix(e, t, o) {
    ...
    if ((c.removeChild(r), n))
      for (a = n.length; a--; ) ((s = n[a]).scaleX = s.scaleY = 0), s.renderTransform(1, s)
  ...
  function ra() {
    return !ze.length && fe.ticker.remove(pa)
  }
  function sa(e) {
  ...
  function ya(e) {
    ;(ke = e.touches && Te < e.touches.length), va(e.target, 'touchend', ya)
  }
  function za(e) {
    ;(ke = e.touches && Te < e.touches.length), ua(e.target, 'touchend', ya)
  }
  function Aa(e) {
  ...
  function Ca(e, t) {
    ua(e, 'scroll', t), Ae(e.parentNode) || Ca(e.parentNode, t)
  }
  function Da(e, t) {
    va(e, 'scroll', t), Ae(e.parentNode) || Da(e.parentNode, t)
  }
  function Fa(e, t) {
    ...
    return Math.max(
      0,
      Ae(e) ? Math.max(xe[n], s[n]) - (me['inner' + o] || xe[i] || s[i]) : e[n] - e[i]
    )
  }
  function Ga(e, t) {
    var o = Fa(e, 'x'),
      n = Fa(e, 'y')
    Ae(e) ? (e = Be) : Ga(e.parentNode, t),
      (e._gsMaxScrollX = o),
      (e._gsMaxScrollY = n),
  ...
  function Ka(e) {
    if (e === me)
      return (
        (N.left = N.top = 0),
        (N.width = N.right = xe.clientWidth || e.innerWidth || s.clientWidth || 0),
        (N.height = N.bottom =
  ...
  function La(e, t, o) {
    var n,
      ...
      a = e._listeners[t]
    return (
      V(r) && (n = r.apply(i.callbackScope || e, i[o + 'Params'] || [e.pointerEvent])),
          ...
          (i &&
            ...
            (i && !e) ||
              ...
              (y = Math.max(0, r.scrollWidth - r.clientWidth)) &&
                (y += parseFloat(t.paddingLeft) + (I ? parseFloat(t.paddingRight) : 0))),
  ...
  function Draggable(g, p) {
            ...
            Be.scrollLeft =
              null != me.pageXOffset
                ...
                : null != ce.documentElement.scrollLeft
                  ...
                  : ce.body.scrollLeft,
            i = Z.pointerX - Be.scrollLeft,
            r = Z.pointerY - Be.scrollTop;
          c && !o;

        )
          (t = (o = Ae(c.parentNode)) ? Be : c.parentNode),
            (n = o
              ? {
            ...
            o &&
              (a || s) &&
              (me.scrollTo(t.scrollLeft, t.scrollTop), ue(Z.pointerX + a, Z.pointerY + s)),
            (c = t)
      }
      if (C) {
        var p = Z.x,
          u = Z.y
        q
          ? ((Z.deltaX = p - parseFloat(se.rotation)),
            (Z.rotation = p),
            (se.rotation = p + 'deg'),
            se.renderTransform(1, se))
          : h
            ? (U && ((Z.deltaY = u - h.top()), h.top(u)),
              j && ((Z.deltaX = p - h.left()), h.left(p)))
            : G
              ? (U && ((Z.deltaY = u - parseFloat(se.y)), (se.y = u + 'px')),
                j && ((Z.deltaX = p - parseFloat(se.x)), (se.x = p + 'px')),
                se.renderTransform(1, se))
              : (U && ((Z.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + 'px')),
                j && ((Z.deltaY = p - parseFloat(g.style.left || 0)), (g.style.left = p + 'px'))),
          !f ||
            e ||
            A ||
            (!(A = !0) === La(Z, 'drag', 'onDrag') &&
              (j && (Z.x -= Z.deltaX), U && (Z.y -= Z.deltaY), ai(!0)),
            (A = !1))
      }
      C = !1
    }
        ...
        G
          ...
          : q
            ...
            : h
              ...
              : ((Z.y = parseInt(g.style.top || ((n = Ia(g)) && n.top), 10) || 0),
                (Z.x = parseInt(g.style.left || (n || {}).left, 10) || 0)),
        (H || z || I) &&
          !t &&
          ...
          (I &&
            ((Ne.x = Z.x),
            (Ne.y = Z.y),
            (o = I(Ne)).x !== Z.x && ((Z.x = o.x), (C = !0)),
            o.y !== Z.y && ((Z.y = o.y), (C = !0))),
          H && (o = H(Z.x)) !== Z.x && ((Z.x = o), q && (Z.rotation = o), (C = !0)),
          z && ((o = z(Z.y)) !== Z.y && (Z.y = o), (C = !0))),
        C && ai(!0),
    ...
    function ei() {
      ...
      ;(M = !1),
        h
          ? (h.calibrate(),
            (Z.minX = L = -h.maxScrollLeft()),
            (Z.minY = E = -h.maxScrollTop()),
            (Z.maxX = D = Z.maxY = S = 0),
            (M = !0))
          : p.bounds &&
            ...
            q
              ? ((Z.minX = L = e.left),
                (Z.maxX = D = e.left + e.width),
                (Z.minY = E = Z.maxY = S = 0))
              : X(p.bounds.maxX) && X(p.bounds.maxY)
                ? ((t = Ma(g, g.parentNode)),
                  (Z.minX = L = Math.round(uh(d, 'px') + e.left - t.left - 0.5)),
                  (Z.minY = E = Math.round(uh(K, 'px') + e.top - t.top - 0.5)),
            ...
            q && ((Z.minRotation = L), (Z.maxRotation = D)),
            (M = !0)),
        p.liveSnap &&
          ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (n = Pe(o) || V(o)),
          q
            ? ((H = ci(n ? o : o.rotation, L, D, 1)), (z = null))
            : o.points
              ...
              : (j && (H = ci(n ? o : o.x || o.left || o.scrollLeft, L, D, h ? -1 : 1)),
                U && (z = ci(n ? o : o.y || o.top || o.scrollTop, E, S, h ? -1 : 1))))
    }
    function fi() {
    ...
    function hi(e, t) {
      ...
      e && De
        ? (!0 === e &&
            ((o = p.snap || p.liveSnap || {}),
            (n = Pe(o) || V(o)),
            (e = { resistance: (p.throwResistance || p.resistance || 1e3) / (q ? 10 : 1) }),
            q
              ...
              : (j &&
                ...
                (o.points || (Pe(o) && W(o[0]))) &&
                  ((e.linkedProps = d + ',' + K), (e.radius = o.radius)))),
          (Z.isThrowing = !0),
    ...
    function ii(e) {
      ...
      ;(R = getGlobalMatrix(g.parentNode, !0)),
        e &&
          Z.isPressed &&
          !R.equals(o || new he()) &&
          ((t = o.inverse().apply({ x: b, y: w })), R.apply(t, t), (b = t.x), (w = t.y)),
        R.equals(a) && (R = null)
    }
    function ji() {
      var e,
      ...
      ii(!1),
        R && ((Oe.x = Z.pointerX), (Oe.y = Z.pointerY), R.apply(Oe, Oe), (b = Oe.x), (w = Oe.y)),
        C && (ue(Z.pointerX, Z.pointerY), ai(!0)),
        h
          ? (ei(), (k = h.top()), (T = h.left()))
          : (de() ? (bi(!0, !0), ei()) : Z.applyBounds(),
            q
              ? ((e = g.ownerSVGElement
                ...
                le && ((t -= Ba(ce)), (o += Aa(ce))),
                (T = Z.x),
                (k = Z.y = Math.atan2(o, t) * Ce))
              : ((k = uh(K, 'px')), (T = uh(d, 'px')))),
        M &&
          n &&
          (D < T ? (T = D + (T - D) / n) : T < L && (T = L - (L - T) / n),
          q || (S < k ? (k = S + (k - S) / n) : k < E && (k = E - (E - k) / n))),
        (Z.startX = T),
        (Z.startY = k)
    }
    function li() {
      !ye.parentNode || de() || Z.isDragging || ye.parentNode.removeChild(ye)
    }
    function mi(e, t) {
      var o
      if (
        ...
        if (
          ...
          _e[e.type]
            ? ((y = ~e.type.indexOf('touch') ? e.currentTarget || e.target : ce),
              ...
              ua(y, 'touchcancel', ge),
              ua(ce, 'touchstart', za))
            : ((y = null), ua(ce, 'mousemove', pe)),
          (B = null),
          (Se && y) || (ua(ce, 'mouseup', ge), e && e.target && ua(e.target, 'mouseup', ge)),
          (x = re.call(Z, e.target) && !1 === p.dragClickables && !t))
        )
          return (
            ua(e.target, 'change', ge),
        ...
        if (
          ((N =
            !(
              ...
              (Z.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))
            ) && (j ? 'y' : 'x')),
          (F = !N && !Z.allowEventDefault) && (wa(e), ua(me, 'touchforcechange', wa)),
          e.changedTouches
          ...
          (function _addToRenderQueue(e) {
            ze.push(e), 1 === ze.length && fe.ticker.add(pa)
          })(ai),
          (w = Z.pointerY = e.pageY),
          (b = Z.pointerX = e.pageX),
          La(Z, 'pressInit', 'onPressInit'),
          (N || Z.autoScroll) && Ga(g.parentNode),
          !g.parentNode ||
            !Z.autoScroll ||
            h ||
            q ||
    ...
    function qi(e) {
      if (e && Z.isDragging && !h) {
        ...
        ;(o || n) &&
          (R ? ((b -= o * R.a + n * R.c), (w -= n * R.d + o * R.b)) : ((b -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
          ue(Z.pointerX, Z.pointerY))
      }
    }
    function ri(e) {
      var t = He(),
      ...
      if (
        ((i || (n && !1 !== Z.vars.suppressClickOnDrag)) &&
          e.stopImmediatePropagation &&
          e.stopImmediatePropagation(),
        o && (!Z.pointerEvent || !Z.pointerEvent.defaultPrevented) && (!i || (s && !a)))
      )
    ...
    var u,
      ...
      q = -1 !== o.indexOf('rotation'),
      d = q ? 'rotation' : G ? 'x' : 'left',
      K = G ? 'y' : 'top',
      ...
      pe = function onMove(e) {
        ...
        if (u && !ke && Z.isPressed && e) {
          ...
          (o = Oe.x),
          (n = Oe.y),
          (((r = Math.abs(o - b)) !== (a = Math.abs(n - w)) && (Q < r || Q < a)) ||
            (Me && N === B)) &&
            ((B = a < r && j ? 'x' : 'y'),
            N && B !== N && ua(me, 'touchforcechange', wa),
            !1 !== Z.vars.lockAxisOnTouchScroll &&
              j &&
              U &&
              ((Z.lockedAxis = 'x' === B ? 'y' : 'x'),
              V(Z.vars.onLockAxis) && Z.vars.onLockAxis.call(Z, s)),
            Me && N === B))
            ? ge(s)
            : ((F =
                Z.allowEventDefault || (N && (!B || N === B)) || !1 === s.cancelable
                  ? F && !1
                  : (wa(s), !0)),
              Z.autoScroll && (ee = !0),
              ue(e.pageX - (le && q ? Ba(ce) : 0), e.pageY - (le && q ? Aa(ce) : 0), l))
        } else F && e && u && wa(e)
      },
      ue = function setPointerPosition(e, t, o) {
        ...
        ;(Z.pointerX = e),
          (Z.pointerY = t),
          q
            ? ((a = Math.atan2(P.y - t, e - P.x) * Ce),
              180 < (s = Z.y - a) ? ((k -= 360), (Z.y = a)) : s < -180 && ((k += 360), (Z.y = a)),
              (r = Z.x !== T || Math.abs(k - a) > Q ? ((Z.y = a), T + (k - a) * c) : T))
            : (R && ((l = e * R.a + t * R.c + R.e), (t = e * R.b + t * R.d + R.f), (e = l)),
              (i = t - w) < Q && -Q < i && (i = 0),
              (n = e - b) < Q && -Q < n && (n = 0),
              (Z.lockAxis || Z.lockedAxis) &&
                (n || i) &&
                ((l = Z.lockedAxis) ||
                  ((Z.lockedAxis = l = j && Math.abs(n) > Math.abs(i) ? 'y' : U ? 'x' : null),
                  l && V(Z.vars.onLockAxis) && Z.vars.onLockAxis.call(Z, Z.pointerEvent)),
                'y' === l ? (i = 0) : 'x' === l && (n = 0)),
              (r = _(T + n * c)),
              (a = _(k + i * c))),
          (H || z || I) && (Z.x !== r || (Z.y !== a && !q))
            ? (I && ((Ne.x = r), (Ne.y = a), (l = I(Ne)), (r = _(l.x)), (a = _(l.y))),
              H && (r = _(H(r))),
              z && (a = _(z(a))))
            : M &&
              (D < r
                ? (r = D + Math.round((r - D) * d))
                : r < L && (r = L + Math.round((r - L) * d)),
              q ||
                (S < a
          ...
          (Z.x === r && (Z.y === a || q)) ||
            (q
              ? ((Z.endRotation = Z.x = Z.endX = r), (C = !0))
              : (U && ((Z.y = Z.endY = a), (C = !0)), j && ((Z.x = Z.endX = r), (C = !0))),
            o && !1 === La(Z, 'move', 'onMove')
              ...
              : !Z.isDragging &&
                Z.isPressed &&
                ((Z.isDragging = !0), La(Z, 'dragstart', 'onDragStart')))
      },
      ge = function onRelease(e, t) {
        if (
          ...
          if (
            ...
            (Se && y) ||
              (va(ce, 'mouseup', onRelease), e && e.target && va(e.target, 'mouseup', onRelease)),
            (C = !1),
            x && !c)
          )
            return (
              e && (va(e.target, 'change', onRelease), (Z.pointerEvent = s)),
              Ra(J, !1),
          ...
          if ((sa(ai), !q))
            for (n = J.length; -1 < --n; )
              Ha(J[n], 'cursor', p.cursor || (!1 !== p.cursor ? Le : null))
          if ((l && (($ = Ye = He()), (Z.isDragging = !1)), Te--, e)) {
          ...
          return (
            c && s
              ...
              : s && !l
                ? ((F = !1),
                  Y && (p.snap || p.bounds) && hi(p.inertia || p.throwProps),
                  La(Z, 'release', 'onRelease'),
                  (Me && 'touchmove' === s.type) ||
                    -1 !== s.type.indexOf('cancel') ||
                    (La(Z, 'click', 'onClick'),
                    He() - ae < 300 && La(Z, 'doubleclick', 'onDoubleClick'),
                    (r = s.target || g),
                    (ae = He()),
                    ...
                    Me || s.defaultPrevented || fe.delayedCall(0.05, a)))
                : (hi(p.inertia || p.throwProps),
                  Z.allowEventDefault ||
                  !s ||
                  (!1 === p.dragClickables && re.call(Z, s.target)) ||
                  !l ||
                  (N && (!B || N !== B)) ||
                  !1 === s.cancelable
                    ? (F = !1)
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var o, n, i, r
        mi(e || Z.pointerEvent, !0),
          t &&
            !Z.hitTest(e || Z.pointerEvent) &&
            ((o = Ka(e || Z.pointerEvent)),
            (n = Ka(g)),
            (i = si({ x: o.left + o.width / 2, y: o.top + o.height / 2 })),
            (r = si({ x: n.left + n.width / 2, y: n.top + n.height / 2 })),
            (b -= i.x - r.x),
            (w -= i.y - r.y)),
      ...
      (e.getDirection = function (e, t) {
        var o,
          ...
          a,
          s,
          l = 'velocity' === e && De ? e : W(e) && !q ? 'element' : 'start'
        return (
        ...
        if ((bi(!0), ei(), M && !de())) {
          if (
            ...
            (Z.x !== o || Z.y !== n) &&
              ((i = !0),
              (Z.x = Z.endX = o),
              q ? (Z.endRotation = o) : (Z.y = Z.endY = n),
              ai((C = !0)),
      ...
      (e.update = function (e, t, o) {
        ...
        return (
          ii(!t),
          e ? Z.applyBounds() : (C && o && ai(!0), bi(!0)),
          t && (ue(Z.pointerX, Z.pointerY), C && ai(!0)),
          Z.isPressed &&
            !t &&
            ((j && 0.01 < Math.abs(n - Z.x)) || (U && 0.01 < Math.abs(i - Z.y) && !q)) &&
            ji(),
          Z.autoScroll &&
            (Ga(g.parentNode, Z.isDragging), (ee = Z.isDragging), ai(!0), Da(g, qi), Ca(g, qi)),
          Z
        )
      }),
      (e.enable = function (e) {
        var t,
          ...
          i = { lazy: !0 }
        if (
          (q || !1 === p.cursor || (i.cursor = p.cursor || Le),
          ...
          for (o = J.length; -1 < --o; )
            (n = J[o]),
              ...
              p.allowContextMenu || ua(n, 'contextmenu', _h)
          Ra(J, !1)
        }
        return (
          Ca(g, qi),
          (u = !0),
          De && 'soft' !== e && De.track(h || g, G ? 'x,y' : q ? 'rotation' : 'top,left'),
          (g._gsDragID = t = 'd' + Re++),
          (Ie[t] = Z),
      ...
      (e.disable = function (e) {
        var t,
          o,
          n = Z.isDragging
        if (!q) for (t = J.length; -1 < --t; ) Ha(J[t], 'cursor', null)
        if ('soft' !== e) {
          for (t = J.length; -1 < --t; )
            (o = J[t]),
              Ha(o, 'touchCallout', null),
              Ha(o, 'touchAction', null),
              va(o, 'mousedown', mi),
              va(o, 'touchstart', mi),
              va(o, 'click', ri),
              va(o, 'contextmenu', _h)
          Ra(J, !0),
            y && (va(y, 'touchcancel', ge), va(y, 'touchend', ge), va(y, 'touchmove', pe)),
            va(ce, 'mouseup', ge),
            va(ce, 'mousemove', pe)
        }
        return (
          Da(g, qi),
          (u = !1),
          De && 'soft' !== e && De.untrack(h || g, G ? 'x,y' : q ? 'rotation' : 'top,left'),
          h && h.disable(),
          sa(ai),
          (Z.isDragging = Z.isPressed = x = !1),
          n && La(Z, 'dragend', 'onDragEnd'),
          Z
        )
      }),
      ...
      ~o.indexOf('scroll') &&
        ...
        (g.style.overflowX = j && !we ? 'auto' : 'hidden'),
        (g = h.content)),
      q ? (n.rotation = 1) : (j && (n[d] = 1), U && (n[K] = 1)),
  ...
  !(function _setDefaults(e, t) {
    ...
    (G.zIndex = 1e3),
    (G.version = '3.3.3'),
    U() && fe.registerPlugin(G)
  function mb() {
    return 'undefined' != typeof window
  }
  function nb() {
    return q || (mb() && (q = window.gsap) && q.registerPlugin && q)
  }
  function ob(e) {
  ...
  function yb(e, t, o) {
    var n = j.createElementNS ? j.createElementNS('svg' === e ? se : le, e) : j.createElement(e)
    return (
      t && (ob(t) && (t = j.querySelector(t)), t.appendChild(n)),
      'svg' === e && (n.setAttribute('xmlns', se), n.setAttribute('xmlns:xlink', le)),
      o && (n.style.cssText = o),
      n
    )
  }
  function zb() {
    j.selection ? j.selection.empty() : O.getSelection && O.getSelection().removeAllRanges()
  }
  function Bb(e, t) {
    var o = 0,
  ...
  function Hb(t, e, o, n) {
    ...
    if (
      ...
      'mousedown' === e &&
        (r = rb(t.onpointerdown) ? (rb(t.ontouchstart) ? null : 'touchstart') : 'pointerdown'))
    )
      return (
        (i = function handler(e) {
          'select' !== e.target.nodeName.toLowerCase() && e.type === r
            ? (e.stopPropagation(), ue && (e.preventDefault(), o.call(t, e)))
            : e.type !== r && o.call(t, e),
            (ue = !0)
        }),
  ...
  function Jb(e, t, o, n) {
    ...
    n &&
      ((i = yb('option', e)).setAttribute('value', t),
      (i.innerHTML = o.innerHTML = ob(n) ? n : t),
    ...
    if (ee) {
      for (e = Z._dur; n; )
        (t = n._next),
          ...
          (pb(o) && o === n.vars.onComplete && !n._dur) ||
            (o && o._gsIgnore) ||
  ...
  function Ob(e) {
    return q.getById(e) || oe.getById(e) || (e === Z.vars.id && Z)
  }
  function Pb(e) {
    ;(q = e || nb()) &&
      mb() &&
      ...
      (O = window),
      q.registerPlugin(G),
      ((F = q.globalTimeline)._sort = !0),
      (F.autoRemoveChildren = !1),
      (J = q.core.Animation),
      (oe = q.timeline({ data: 'indy', autoRemoveChildren: !0, smoothChildTiming: !0 })).kill(),
      (oe._dp = 0),
      oe.to({}, { duration: 1e12 }),
      (Z = q.timeline({
        data: 'root',
      ...
      (oe._start = q.ticker.time),
      q.ticker.add(function (e) {
        return oe.render(e - oe._start)
      }),
      (F._start += F._time),
      (Z._start = F._time = F._tTime = 0),
      (ne = function _delayedCall(e, t, o, n) {
        return q.to(t, {
          delay: e,
          duration: 0,
          onComplete: t,
      ...
      ne(2, function () {
        var e, t, o
        if (!ee)
          for (Lb(), e = Z._first, o = Z._start; e; )
            (t = e._next),
              e._tDur !== e._tTime || (!e._dur && 1 !== e.progress())
                ? F.add(e, e._start - e._delay + o)
                : e.kill(),
              (e = t)
        2 < ge.globalRecordingTime
          ? ne(ge.globalRecordingTime - 2, function () {
              ee && ee.update(), (F.autoRemoveChildren = !0)
            })
  ...
  var q,
    ...
    ge = function GSDevTools(r) {
      K || (Pb(), q || console.warn('Please gsap.registerPlugin(GSDevTools)')),
        (this.vars = r = r || {}),
        r.animation &&
          (
        ...
        (r.id = r.id || (ob(r.animation) ? r.animation : ce++)),
        (de[r.id + ''] = this),
      ...
      function fo(c, d, p) {
        return function (e) {
          var t,
            ...
            l = a
          p &&
            (c !== k && (t = k.getBoundingClientRect()).left && (a += t.left + t.width - o.left),
            c !== M && (t = M.getBoundingClientRect()).left && (s -= o.left + o.width - t.left)),
            (m = P),
      ...
      function lo(e) {
        if (!I.isPressed) {
          ...
          if (o < D) return (D = o = Math.max(0, o)), (k.style.left = D + '%'), void R.startDrag(e)
          if (L < o)
            return (L = o = Math.min(100, o)), (M.style.left = L + '%'), void Y.startDrag(e)
          v.progress(o / 100).pause(), N(!0), I.startDrag(e)
        }
      }
      function po() {
        if (!I.isPressed) {
      ...
      function qo(e) {
        if ((yn('loop', (d = e)), d)) {
          if ((X.play(), v.progress() >= L / 100)) {
            var t = v._targets && v._targets[0]
            t === i && t.seek(s + ((l - s) * D) / 100),
              i._repeat && !D && 100 === L ? v.totalProgress(0, !0) : v.progress(D / 100, !0),
              B()
          }
        } else X.reverse()
      }
      ...
      function so() {
        var e,
          ...
          i = 0
        for (
          a && !r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(Z), t = 0;
          t < o.length;
          t++
        )
          ((e = n[t] || yb('option', S)).animation = o[t]),
      ...
      function to(e) {
        var t,
          o,
          n = parseFloat(H.options[H.selectedIndex].value) || 1
        if (!arguments.length) return i
        if (
          (ob(e) && (e = Ob(e)),
          e instanceof J || console.warn('GSDevTools error: invalid animation.'),
          e !== i)
        ) {
          if (
            ...
            (k.style.left = D + '%'),
            (M.style.left = L + '%'),
            c && (yn('animation', i.vars.id), yn('in', D), yn('out', L)),
            (s = 0),
            (o = r.maxDuration || Math.min(1e3, Bb(i))),
            i === Z || r.globalSync)
          ) {
            if (
              (Lb(),
            ...
            o < l - s && (l = s + o),
              ...
              ($.vars.time = l),
              $.invalidate(),
              $.duration(l - s).timeScale(n),
              P
                ? $.progress(1).pause(0)
                : ne(0.01, function () {
                    $.resume().progress(D / 100), P && B()
                  })
          } else {
            if ((ee === p && (ee = null), i !== a && a)) {
              for (
                99999999 < (l = (t = i).totalDuration()) && (l = t.duration());
                t.parent.parent && t !== a;
              ...
              o < l - s && (l = s + o),
                a.pause(s),
                (v = q.to(a, { duration: l - s, time: l, ease: 'none', data: 'root', parent: oe }))
            } else (v = i), !d && v._repeat && qo(!0)
            v.timeScale(n), $.pause(), Z.resume(), v.seek(0)
          }
          ;(_.innerHTML = v.duration().toFixed(2)), Jb(S, i.vars.id, E)
        }
      }
      function vo(e) {
        to(S.options[S.selectedIndex].animation),
          e.target && e.target.blur && e.target.blur(),
          P && B()
      }
      function wo() {
        var e,
          t = parseFloat(H.options[H.selectedIndex].value) || 1
        v.timeScale(t),
          yn('timeScale', t),
          P ||
            (v.progress() >= L / 100
      ...
      function zo(e) {
        G.hitTest(e, n) || I.isDragging || R.isDragging || Y.isDragging || V.restart(!0)
      }
      function Ao() {
        W || (F.play(), V.pause(), (W = !0))
      }
      function Bo() {
        V.pause(), W && (F.reverse(), (W = !1))
      }
      function Eo(e) {
        re && !ae && (ae = Z._start),
          (c = !e),
          ...
          Lb(),
          so()
        var t = Ob(zn('animation'))
        t && ((t._inProgress = zn('in') || 0), (t._outProgress = zn('out') || 100)),
          r.paused && A(),
          (i = null),
          to(a || t || Z)
        var o = r.timeScale || zn('timeScale'),
          n = t === i
        o && (Jb(H, o, z, o + 'x'), v.timeScale(o)),
          100 === (D = ('inTime' in r ? Db(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) &&
            !r.animation &&
            t &&
            (to(Z), (D = Db(r.inTime, i, 0, 0) || 0)),
          D && ((k.style.left = D + '%'), (k.style.display = M.style.display = 'block')),
          (L = ('outTime' in r ? Db(r.outTime, i, 100, D) : n ? t._outProgress : 0) || 100) < D &&
            (L = 100),
          100 !== L && ((M.style.left = L + '%'), (k.style.display = M.style.display = 'block')),
          (d = 'loop' in r ? r.loop : zn('loop')) && qo(!0),
          r.paused && v.progress(D / 100, !0).pause(),
          re && i === Z && ae && r.globalSync && !P && v.time(-ae, !0),
          N(!0)
      }
      var u,
        g,
        ...
        n = (function _createRootElement(e, t, o) {
          ie ||
            ...
            (ie = !0)),
            ob(e) && (e = j.querySelector(e))
          var n = yb('div', e || Q.getElementsByTagName('body')[0] || Q)
          return (
            ...
            o &&
              (ob(o)
                ...
                : (function _isObject(e) {
                    return 'object' == typeof e
                  })(o) && ((o.data = 'root'), q.set(n, o).kill()),
              n.style.top && (n.style.bottom = 'auto'),
              n.style.width &&
                q.set(n, { xPercent: -50, left: '50%', right: 'auto', data: 'root' }).kill()),
            !t &&
              n.offsetWidth < 600 &&
        ...
        H = xn('.time-scale select'),
        z = xn('.time-scale-label'),
        I = G.create(x, {
          type: 'x',
          cursor: 'ew-resize',
          ...
          onDrag: function onDrag() {
            ...
            e < 0 ? (e = 0) : e > v._dur && (e = v._dur),
              f || v.time(e),
              (b.style.width = Math.min(L - D, Math.max(0, (e / v._dur) * 100 - D)) + '%'),
        ...
        R = G.create(k, {
          ...
          onDoubleClick: ho,
          onDrag: function onDrag() {
            ;(D = ((g + u * this.x) / v.duration()) * 100), v.progress(D / 100), N(!0)
          },
          onRelease: function onRelease() {
            D < 0 && (D = 0),
              zb(),
        ...
        Y = G.create(M, {
          ...
          onDoubleClick: ho,
          onDrag: function onDrag() {
            ;(L = ((g + u * this.x) / v.duration()) * 100), v.progress(L / 100), N(!0)
          },
          onRelease: function onRelease() {
            100 < L && (L = 100),
              zb(),
            ...
            100 < o && (o = 100),
              L <= o
                ? !d || v.paused() || I.isDragging
                  ? ((o === L && -1 !== i._repeat) || ((o = L), v.progress(o / 100)),
                    !P && (L < 100 || 1 === i.totalProgress() || -1 === i._repeat) && A())
                  : n ||
                    ((o = D),
      ...
      Hb(S, 'change', vo),
        Hb(S, 'mousedown', so),
        Hb(t, 'mousedown', O),
        Hb(xn('.seek-bar'), 'mousedown', lo),
        Hb(xn('.rewind'), 'mousedown', po),
        Hb(C, 'mousedown', ro),
        Hb(H, 'change', wo),
        'auto' === r.visibility
          ? (Hb(n, 'mouseout', zo), Hb(n, 'mouseover', Bo))
              ...
              Hb(
                ...
                (e = function keyboardHandler(e) {
                  ...
                  32 === o
                    ? O()
                    : 38 === o
                      ? ((t = parseFloat(Kb(H, -1, z))), v.timeScale(t), yn('timeScale', t))
                      : 40 === o
                        ? ((t = parseFloat(Kb(H, 1, z))), v.timeScale(t), yn('timeScale', t))
                        : 37 === o
                          ? po()
        ...
        q.set(k, { xPercent: -100, x: 0, data: 'root' }),
        (k._gsIgnore = M._gsIgnore = x._gsIgnore = t._gsIgnore = C._gsIgnore = !0),
        q.killTweensOf([k, M, x]),
        Eo(re),
        re && ne(1e-4, Eo, [!1], this),
        q.ticker.add(N),
          ...
          ee === p &&
            ...
            (function updateRootDuration() {
              ...
              i === Z &&
                ...
                (e = ($._dp._time - $._start) * $._ts),
                1e3 === (o = Math.min(1e3, Z.duration())) && (o = Math.min(1e3, Bb(Z))),
                1 != (t = $.duration() / o) &&
                  o &&
                  ((D *= t),
                  L < 100 && (L *= t),
        ...
        (this.kill = function () {
          Ib(S, 'change', vo),
            Ib(S, 'mousedown', so),
            Ib(t, 'mousedown', O),
            Ib(xn('.seek-bar'), 'mousedown', lo),
            Ib(xn('.rewind'), 'mousedown', po),
            Ib(C, 'mousedown', ro),
            Ib(H, 'change', wo),
            I.disable(),
            R.disable(),
  ...
  ;(ge.version = '3.3.3'),
    ...
    (ge.getByAnimation = function (e) {
      for (var t in (ob(e) && (e = q.getById(e)), de)) if (de[t].animation() === e) return de[t]
    }),
    (ge.create = function (e) {
      return new ge(e)
    }),
    (ge.register = Pb),
    nb() && q.registerPlugin(ge),
    (e.GSDevTools = ge),
    (e.default = ge)
