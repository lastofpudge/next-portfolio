    ...
    s = {
      ...
      render: function render(e, t) {
        ...
        if (1 === t.fr)
          ...
          if (((r = p = (0 | (w *= u)) - h), (o = w % 1), 0 <= p))
            for (; p--; )
              (c.v += c.a), (l.v += l.a), (c.v *= d), (l.v *= d), (c.val += c.v), (l.val += l.v)
          else
            for (p = -p; p--; )
              (c.val -= c.v), (l.val -= l.v), (c.v /= d), (l.v /= d), (c.v -= c.a), (l.v -= l.a)
          ;(s = c.val + c.v * o), (n = l.val + l.v * o), (t.step += r)
        }
        g || c.set(f, c.p, i(s) + c.u), y || l.set(f, l.p, i(n) + l.u)
      },
