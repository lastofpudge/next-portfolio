...
!(function (t, e) {
  ...
  function Y(t, e, r, i, n, o) {
    ...
    if (((r = isNaN(r) ? B : r), (i = isNaN(i) ? -B : i), M(e))) {
      if (((a = e.calculated ? e : (N(c) ? c(e) : X(e, c, r, i, o)) || e), !e.calculated)) {
        for (s in a) e[s] = a[s]
        e.calculated = !0
      }
      a = a[n]
    } else a = N(c) ? c(e) : w(c) ? X(e, c, r, i, o) : parseFloat(c)
    return r < a ? (a = r) : a < i && (a = i), { max: a, min: a, unitFactor: t.unitFactor }
  }
  function Z(t, e, r) {
      ...
      init: function init(t, e, r, i, n) {
                ...
                for (a in ((v = ba(t, y, k, T)), y))
                  I[a] ||
                    ...
                    M(s) &&
                      ...
                      'end' in s &&
                        ((s = Y(s, v && a in v ? v : l, s.max, s.min, a, y.radius)),
        ...
        for (a in ((e = C), (C = 0), (d = ba(t, e, h, T)), e))
          I[a] ||
            ...
            M(s) &&
              ((p = c + l),
              'end' in s && (s = Y(s, d && a in d ? d : p, s.max, s.min, a, e.radius)),
              'max' in s && +s.max < p
