  ...
  var u,
    ...
    e = {
      ...
      render: function render(D, u) {
        ...
        p &&
          (A._from && (H = A._dur - H),
          (D = 0 === H ? 0 : H < p ? 1e-6 : H === A._dur ? 1 : A._ease((H - p) / (A._dur - p)))),
          D < 0 ? (D = 0) : 1 < D && (D = 1),
          b && (D = 1 - D),
          (F = ~~(D * M + 0.5)),
          (e = D
            ...
            ? 1 !== D || (!A._from && 'isFromStart' !== A.data)
              ? ((n = l.slice(F).join(o)),
                (E = x
                  ...
                  : e.substr(
                      0,
                      (d + (j ? 1 - D * D * D : 1) * S - (m ? emojiSafeSplit(n) : n).length + 0.5) |
                        0
                    )),
                n)
              : ((E = ''), L.join(o))
          ...
          (n = _
            ? ((t = (r = b ? w : v) && 0 != F) ? "<span class='" + r + "'>" : '') +
              E +
              (t ? '</span>' : '') +
              ((i = (s = b ? v : w) && F !== M) ? "<span class='" + s + "'>" : '') +
              o +
              e +
              (i ? '</span>' : '')
            : E + o + e),
