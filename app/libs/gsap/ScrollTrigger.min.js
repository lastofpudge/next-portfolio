...
!(function (e, t) {
      ...
      ;(te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed && (se._vx.reset(), se._vy.reset(), B(F ? n : ve, Be[1], Ve, !0)),
  ...
  function tb(e, t) {
    if (Ja(e)) {
      ...
      ~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in D ? D[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0))
    }
    return e
  }
  ...
  function Cb() {
    Le.cache++,
      nt ||
        ...
        (v && m === We.innerWidth && !(Math.abs(We.innerHeight - b) > 0.25 * We.innerHeight)) ||
        l.restart(!0)
  }
  function Fb() {
  ...
  var Ke,
    ...
    j = function _updateAll(e) {
      if (!ut || 2 === e) {
        ...
        if (
          ((Bt = o < W ? -1 : 1),
          (W = o),
          n && (ht && !ot && 200 < r - ht && ((ht = 0), H('scrollEnd')), (rt = w), (w = r)),
          Bt < 0)
        ) {
    ...
    Z =
      ((ScrollTrigger.prototype.init = function init(_, T) {
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
          ...
          if (
            ...
            (we.vars = _),
            (T = T || _.animation),
            'refreshPriority' in _ && ((at = 1), -9999 === _.refreshPriority && (dt = we)),
            ...
            ce &&
              ...
              Le.forEach(function (e) {
                return (
                  Ka(e) && e.target === (be ? je.scrollingElement || qe : ve) && (e.smooth = !1)
                )
              }),
              (p = Ka(ce.snapTo)
                ? ce.snapTo
          ...
          ;(we.previous = function () {
                ...
                if (oe && e && ht) nb(ScrollTrigger, 'scrollEnd', Fb)
                  ...
                  for (
                    var r,
                      ...
                      x = (we.pinnedContainer = _.pinnedContainer && I(_.pinnedContainer)),
                  ...
                  for (
                    Ka(y) && (y = y(we)),
                      M = bc(y, ne, d, ge, Me(), C, D, we, p, Se, me, g, fe) || (oe ? -0.001 : 0),
                      Ka(b) && (b = b(we)),
                      Ja(b) &&
                        !b.indexOf('+=') &&
                        (~b.indexOf(' ')
            ...
            (we.labelToScroll = function (e) {
              return (
                (T && T.labels && (M || we.refresh() || M) + (T.labels[e] / T.duration()) * B) || 0
              )
            }),
            ...
            (we.update = function (e, t, r) {
              if (!fe || r || e) {
                ...
                if (
                  ...
                  if (
                    ((a = (s = (n = we.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p),
            ...
            (we.kill = function (e, t) {
              ...
              0 <= r && Ot.splice(r, 1),
                ...
                T && ((T.scrollTrigger = null), e && T.revert({ kill: !1 }), t || T.kill()),
                C &&
                  [C, O, D, z].forEach(function (e) {
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          a || ((Ke = e || Ca()), Ba() && window.document && ScrollTrigger.enable(), (a = vt)), a
        )
      }),
  ...
  function oc(e) {
    ...
    var n,
      ...
      g = p && p.get(),
      h =
        P && ((e.content && I(e.content)) || (g && !1 !== e.content && !g.smooth() && g.content())),
      v = J(d, Ne),
      b = J(d, Je),
      m = 1,
      y =
    ...
    return (
        ...
        function (e, t) {
          if ((v.offset && Dp(), t)) {
            ...
            f &&
              ...
              ((P && a.vars.scrollY >= i) || i - 1 <= r) && Ke.to({}, { onUpdate: Jp, duration: o })
          } else s.restart(!0)
        }),
      (e.onWheel = function () {
      ...
      (e.onChange = function (e, t, r, n, o) {
        if (
          (It !== l && Cp(), t && f && b(_(n[2] === t ? c + (e.startX - e.x) : b() + t - n[1])), r)
        ) {
          v.offset && Dp()
          var i = o[2] === r,
