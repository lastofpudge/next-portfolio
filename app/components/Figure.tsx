    ...
    <>
      <svg id='motionPath' viewBox='-20 0 557 190'>
        <path
          id='path'
          fill='none'
          d='M69.289,161.434 C76.269,142.422 47.348,20.305 120.378,19.308 195.366,19.308 161.028,146.959 199.155,149.979 251.987,154.163 437.285,136.896 486.285,136.896 573.266,136.896 303.571,50.513 310.571,27.532 '
          transform='matrix(1 0 0 1 3.611 0)'></path>
        <g className='astronaut' opacity={0}>
          <path
            fill='#CCC'
